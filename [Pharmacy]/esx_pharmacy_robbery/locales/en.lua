Locales['en'] = {
	...
	['shop_robbery'] = 'Robbery in Pharmacy',
	...
	['already_robbed'] = 'the pharmacy has already been robbed. Wait: ',
	['seconds'] = 'seconds.',
	['rob_in_prog'] = '~r~ robbery in progress at: ~b~',
	['started_to_rob'] = 'You started the robbery ',
	['do_not_move'] = ', take the pharmacy from the windows!',
	['alarm_triggered'] = 'the alarm has been triggered',
	['hold_pos'] = 'when you\'ve collected all the pharmacy, run away!',
	...
	['end'] = 'The pharmacy has been robbed!',
	...
	['collectinprogress'] = 'pharmacy collection in progress...',
	['michael'] = '~g~You have robbed pharmacy! Now bring ketamine to ~r~michael!',
	['pharmacyblipmap'] = 'pharmacy',
	['press_to_collect'] = 'to collect ketamine',
	['smash_case'] = 'broken windows',
	['press_to_sell'] = 'Press ~INPUT_PICKUP~ to sell Ketamine',
